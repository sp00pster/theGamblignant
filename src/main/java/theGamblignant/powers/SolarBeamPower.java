...
public class SolarBeamPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = VriskaMod.makeID("SolarBeam");
    ...
    public void atStartOfTurn() {
        this.addToBot(new VFXAction(new MindblastEffect(AbstractDungeon.player.dialogX, AbstractDungeon.player.dialogY, AbstractDungeon.player.flipHorizontal)));
    ...
    public AbstractPower makeCopy() {
        return new SolarBeamPower(owner, amount);
    }
}
