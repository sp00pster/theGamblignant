...
public class ThiefFormPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public ThiefFormPower(final AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new ThiefFormPower(owner);
    }
}
