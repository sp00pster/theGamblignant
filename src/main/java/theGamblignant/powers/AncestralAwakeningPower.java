...
public class AncestralAwakeningPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = VriskaMod.makeID("AncestralAwakening");
    ...
    public AbstractPower makeCopy() {
        return new AncestralAwakeningPower(owner);
    }
}
