...
public class GatekeepPower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("gatekeep_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("gatekeep_power32.png"));
