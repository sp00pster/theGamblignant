...
public class Sunslammer extends AbstractVriskaCard {

    public static final String ID = VriskaMod.makeID(Sunslammer.class.getSimpleName());
    public static final String IMG = makeCardPath("sunslammer.png");
