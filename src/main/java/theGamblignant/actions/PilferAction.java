...
public class PilferAction extends AbstractGameAction {
    private DamageInfo info;

    public PilferAction(AbstractCreature target, DamageInfo info) {
        this.info = info;
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    ...
                    for(int i = 0; i < this.target.lastDamageTaken; ++i) {
