...
@SpireInitializer
public class VriskaMod implements
        AddAudioSubscriber,
        EditCardsSubscriber,
    ...
    private static final String MODNAME = "The Gamblignant";
    private static final String AUTHOR = "spoopster";
    private static final String DESCRIPTION = "vriska mod";
    ...
    public VriskaMod() {
        ...
        setModID("theGamblignant");

        logger.info("Done subscribing");
        
        logger.info("Creating the color " + TheGamblignant.Enums.COLOR_COBALT.toString());
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = VriskaMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = VriskaMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = VriskaMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        VriskaMod defaultmod = new VriskaMod();
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new CoolSunglassesRelic(), TheGamblignant.Enums.COLOR_COBALT);
        BaseMod.addRelicToCustomPool(new BrightPowderRelic(), TheGamblignant.Enums.COLOR_COBALT);
        BaseMod.addRelicToCustomPool(new ScratchedCoinRelic(), TheGamblignant.Enums.COLOR_COBALT);
        BaseMod.addRelicToCustomPool(new DimBulbRelic(), TheGamblignant.Enums.COLOR_COBALT);
        BaseMod.addRelicToCustomPool(new PanicPupaRelic(), TheGamblignant.Enums.COLOR_COBALT);
        // BaseMod.addRelicToCustomPool(new DreamBubbleRelic(), TheGamblignant.Enums.COLOR_COBALT);
        // BaseMod.addRelicToCustomPool(new Relic(), TheGamblignant.Enums.COLOR_COBALT);
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(CardStrings.class,
                getModID() + "Resources/localization/eng/TheGamblignant-Card-Strings.json");
        
        // PowerStrings
        BaseMod.loadCustomStringsFile(PowerStrings.class,
                getModID() + "Resources/localization/eng/TheGamblignant-Power-Strings.json");
        
        // RelicStrings
        BaseMod.loadCustomStringsFile(RelicStrings.class,
                getModID() + "Resources/localization/eng/TheGamblignant-Relic-Strings.json");
        
        // Event Strings
        BaseMod.loadCustomStringsFile(EventStrings.class,
                getModID() + "Resources/localization/eng/TheGamblignant-Event-Strings.json");
        
        // PotionStrings
        BaseMod.loadCustomStringsFile(PotionStrings.class,
                getModID() + "Resources/localization/eng/TheGamblignant-Potion-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(getModID() + "Resources/localization/eng/TheGamblignant-Keyword-Strings.json").readString(String.valueOf(StandardCharsets.UTF_8));
